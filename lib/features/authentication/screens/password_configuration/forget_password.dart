...
import 'package:login_trail1/features/authentication/screens/password_configuration/reset_password.dart';
...
class ForgetPassword extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(),
      body: Center(
        child: SizedBox(width: MediaQuery.of(context).size.width * 0.6,
        child: Padding(
